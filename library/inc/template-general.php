 ...
 * @link       https://themehybrid.com/wuqi
...
function hybrid_get_wp_link() {
	...
	return sprintf( '<a class="wp-link" href="%s">%s</a>', esc_url( __( 'https://wordpress.org', 'wuqi' ) ), esc_html__( 'WordPress', 'wuqi' ) );
}
...
function hybrid_get_single_archive_title() {
	...
	return esc_html__( 'Archives', 'wuqi' );
}
...
function hybrid_get_single_year_title() {
	...
	return get_the_date( esc_html_x( 'Y', 'yearly archives date format', 'wuqi' ) );
}
...
function hybrid_get_single_week_title() {
	...
	return sprintf( esc_html__( 'Week %1$s of %2$s', 'wuqi' ), get_the_time( esc_html_x( 'W', 'weekly archives date format', 'wuqi' ) ), get_the_time( esc_html_x( 'Y', 'yearly archives date format', 'wuqi' ) ) );
}
...
function hybrid_get_single_day_title() {
	...
	return get_the_date( esc_html_x( 'F j, Y', 'daily archives date format', 'wuqi' ) );
}
...
function hybrid_get_single_hour_title() {
	...
	return get_the_time( esc_html_x( 'g a', 'hour archives time format', 'wuqi' ) );
}
...
function hybrid_get_single_minute_title() {
	...
	return sprintf( esc_html__( 'Minute %s', 'wuqi' ), get_the_time( esc_html_x( 'i', 'minute archives time format', 'wuqi' ) ) );
}
...
function hybrid_get_single_minute_hour_title() {
	...
	return get_the_time( esc_html_x( 'g:i a', 'minute and hour archives time format', 'wuqi' ) );
}
...
function hybrid_get_search_title() {
	...
	return sprintf( esc_html__( 'Search results for: %s', 'wuqi' ), get_search_query() );
}
...
function hybrid_get_404_title() {
	...
	return esc_html__( '404 Not Found', 'wuqi' );
}
