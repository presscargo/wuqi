...
if ( ! class_exists( 'Hybrid' ) ) {
	...
	final class Hybrid {
		...
		public function includes() {
			...
			require_if_theme_supports( 'wuqi-template-hierarchy', $this->dir . 'inc/class-template-hierarchy.php' );
			...
			require_if_theme_supports( 'wuqi-deprecated', $this->dir . 'inc/functions-deprecated.php' );
